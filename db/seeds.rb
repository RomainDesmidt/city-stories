...
journey_1 = Journey.create!(
  ...
  journey_pois: [
    ...
    JourneyPOI.new(
      ...
      description: "Histoire complétement folle. Avec une amie (qui sortait d'une relation difficile) nous avons grimpé l’échafaudage de la cathédrale, pour atteindre son toit. Nous avons passé 4h à déambuler entre les contreforts, les toits, les ornements pour finir sur la façade et fumé une cigarette en silence. Je lui ai écrit un poème, pour lui remonter le moral.",
      poi: cathedrale,
      text: <<~EOF
    ...
    JourneyPOI.new(
      ...
      description: "Avec un ami, nous collons des phrases découpées dans du papier peint, sur les murs de Nantes. Celle-là est installée sous un pont dégueulasse, à la lumière vitreuse, et l’odeur douteuse. Il y a plusieurs phrases de ce type, cachés dans les entrailles de Nantes, partez à leur recherche !",
    ...
    JourneyPOI.new(
      ...
      description: "Avec un ami nous collons des phrases découpées dans du papier peint sur les murs de Nantes. Celle-là est destinée aux travailleurs du marché de Talensac. Nous voulions laisser un message à ces travailleurs de l’aube.  Il y a plusieurs phrases de ce type caché dans les entrailles de Nantes, partez à leurs recherche !",
      poi: talensac,
      # remote_photo_url: "http://static.panoramio.com/photos/large/29223108.jpg"
...
journey_2 = Journey.create!(
  ...
  journey_pois: [
    ...
    JourneyPOI.new(
      ...
      description: "Et hop, nous prenons nos vélos direction Trentmoult, pour passer l'après-midi avec nos enfants. Ce n’est pas très loin et le déplacement vaut le coup. Ses petites rues sinueuses, et ses couleurs vives rendent ce petit bout de ville très touchant.",
      poi: trentmoult,
      # remote_photo_url: "http://img.over-blog-kiwi.com/0/93/43/01/20160726/ob_60456d_p1130331.jpg"
      video: "https://www.youtube.com/embed/9oXFAp7Epx8"
    ),

    JourneyPOI.new(
      name: "Gare SNCF",
      description: "Après 6 mois de stage à l’étranger, notre fille nous est enfin revenue ! Mon compagnon à filmé la scène qui s’est passée dans la gare, au milieu des gens. C’était très drôle !",
      poi: gare_sncf,
      # remote_photo_url: "http://images.marredelapluie.fr/membres/0/2/photos/167/1675/167528_cimetiere-misericorde_600.jpg"
      video: "https://www.youtube.com/embed/OiJ75m__rZ8"
    ),

    JourneyPOI.new(
      name: "Île de Versailles",
      description: "Avec mon petit copain, nous aimons nous balader le dimanche, sur l’île de Versailles. C’est un petit coin de paradis à l’abri du bruit de la ville, parfait pour se ressourcer.",
      poi: ile_de_versaille,
      photo: File.new(Rails.root.join("db/fixtures/images/versailles.jpg"))
    ),
    JourneyPOI.new(
      name: "Parc de procé",
      description: "Grosse sieste sur la pelouse du parc de Procé. Nous avons été réveillés par le son de la nature, le chant des oiseaux et le bruit de l’eau. C’était vraiment agréable de se déconnecter de temps en temps.",
      poi: parc_de_proce,
...
journey_3 = Journey.create!(
  ...
  journey_pois: [
    ...
    JourneyPOI.new(
      name: "Parc de procé ",
      description: "Je ne pensais pas que Nantes était aussi verte ! Des parcs partout, sauvages, denses en faune et en flore. J’aurais aimé visiter le jardin botanique de Nantes, mais nous n'en aurons pas le temps, la prochaine fois peut-être.",
      poi: parc_de_proce,
    ...
    JourneyPOI.new(
      ...
      description: "Pour la fin de notre séjour à Nantes, nous avions demandé à un nantais, où nous pouvions acheter des souvenirs. Et bien! Tenez-vous bien! Le type nous a fait une visite in.té.grale du passage Pommeray. C’était incroyable et nous avons pu repartir comblés.",
    ...
    JourneyPOI.new(
      ...
      description: "Nous avons tant entendu parler de ces “machines de l'île“ que ce sont pour elles que nous avons décidé de visiter Nantes. Nous avons nagé en pleine science-fiction, dans l’univers Jules vern-ien. Je n’oublierais jamais l’éléphant et le dragon, quelle histoire !",
...
journey_4 = Journey.create!(
  ...
  journey_pois: [
    ...
    JourneyPOI.new(
      name: "Parc du carpa",
      description: "Le parc du carpa possède des barbecues laissés en libre-service. Un groupe de jeune m’a invité à manger un morceau. Je n’ai pas pu refuser ! Ils étaient super sympa. Si vous l’occasion de passer par là, vous vous ferez sûrement inviter aussi.",
      poi: parc_carpa,
